...
```{seealso}
If you want to skip local installation for now, see our online platform at [huggingface.co/spaces/ff-anon/feedback-forensics](https://huggingface.co/spaces/ff-anon/feedback-forensics/) for ready-to-view personality results on popular datasets and models.
```
...
```bash
git clone https://github.com/ff-anon/feedback-forensics.git
