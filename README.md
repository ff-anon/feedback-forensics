<p align="center">
  <a href="https://huggingface.co/spaces/ff-anon/feedback-forensics/">
  ...
  <br>
  [Docs and PyPI badges removed for anonymity]
</p>
...
**Feedback Forensics is an open-source toolkit to measure AI personality changes**. Beyond raw capabilities, *model personality traits*, such as tone and sycophancy, also matter to users. Feedback Forensics can help you track *(1) personality changes encouraged by your human (or AI) feedback datasets* ((documentation not available in anonymous submission)), and *(2) personality traits exhibited by your AI models* ((documentation not available in anonymous submission)). Feedback Forensics includes a *Python API*, an *annotation CLI*, and a *[Gradio](https://www.gradio.app/) visualisation app*. We also provide a corresponding [online platform](https://huggingface.co/spaces/ff-anon/feedback-forensics) tracking personality traits in popular models and datasets.
...
<a href="https://huggingface.co/spaces/ff-anon/feedback-forensics?data=chatbot_arena"><img src="docs/img/button_demo_v2.png" alt="Run demo" width="110px"></a>  [Tutorial link removed for anonymity]|<a href="https://huggingface.co/spaces/ff-anon/feedback-forensics/?data=model_comparison&ann_cols=model_metallamallama370binstruct,model_metallamallama4maverick"><img src="docs/img/button_demo_v2.png" alt="Run demo" width="110px"></a>  [Tutorial link removed for anonymity]|

## Docs 📖

Hosted documentation not available in anonymous submission.

## Online usage 🌍

See our [online platform](https://huggingface.co/spaces/ff-anon/feedback-forensics) to track personality traits in popular models and datasets. No local installation required.
...
> [!NOTE]
> To load more pre-annotated results, run `feedback-forensics --load-web-datasets`. This will load datasets from [HuggingFace](https://huggingface.co/datasets/ff-anon/ff-public-results).

**Next steps**

See the getting started guides (not available in anonymous submission) to analyse your own feedback datasets and models.
...
@software{feedbackforensics,
  ...
  url = {https://github.com/ff-anon/feedback-forensics},
  year = {2026}
}
```
